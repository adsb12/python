...
costbox = soup.find('table', attrs={"class": "Ltbl_list"}) # 전체 영역에서 'a' 태그를 찾지 않고 인기 급상승 영역으로 범위 제한
costs = costbox.find_all('td', attrs={"class": "txtright"}) # 인기 급상승 영역에서 'a'태그 모두 찾아 변수 cartoons에 할당
# print(cartoons)
i = 1
